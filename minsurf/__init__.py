...
"""
deprecated function attempting a direct null space 
transformation for the linearly constrained 
...
def constrained_surface_composite_newton_cotes(left_bd, right_bd, B, n=20, m=2):
    ...
    # old attempt with direct null space transformation
    # this part fails because the transformation step
    # neglects the implicit ordering inherent in the 
    # casadi symbolic variable: each scalar input 
    # argument maps to a discrete grid point and 
    # that mapping is lost with the null space 
    # transformation
